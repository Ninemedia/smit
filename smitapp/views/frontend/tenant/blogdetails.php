        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="body pull-left">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('tenant/blogtenant'); ?>">
                            <i class=""></i> Blog Tenant
                        </a>
                    </li>
                    <li <?php echo ($active_page2 == 'produk' ? 'class="active"' : ''); ?>>
                        <a href="<?php echo base_url('tenant/blogtenant'); ?>">
                            <i class=""></i> <strong>Detail Blog Tenant</strong>
                        </a>
                    </li>
                </ol>
            </div>
                ...
                <script>
                    ...
                    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                    ...
                    var disqus_config = function () {
                        ...
                        this.page.identifier = "<?php echo $blogdata->uniquecode; ?>"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
                    };
