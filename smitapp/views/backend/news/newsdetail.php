...
<div class="row clearfix">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="header">
                <a href="<?php echo base_url('berita'); ?>" class="btn btn-sm btn-success waves-effect back pull-right bottom20">
            ...
            <div class="body">
                ...
                <div class="details-img">
                    <img class="js-animating-object img-responsive" src="<?php echo $news_image; ?>" alt="" style="border: solid 1px #009688 !important;" />
                </div><br />
                <p align="justify">
