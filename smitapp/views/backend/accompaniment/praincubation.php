                                ...
                                <thead>
                                    ...
                                    <tr role="row" class="filter display-hide table-filter">
            							...
            							<td style="text-align: center;">
            								<button class="btn bg-blue waves-effect filter-submit" id="btn_notespra_list">Search</button>
                                            <button class="btn bg-red waves-effect filter-cancel" id="btn_notespra_listreset">Reset</button>
            							</td>
            						</tr>
                                </thead>
                                <tbody>
