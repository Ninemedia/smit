                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="list">
                        <div class="table-container table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="blogtenant_list" data-url="<?php echo base_url('newslistdata'); ?>">
                                <thead>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="add">
                        <?php echo form_open_multipart( 'tenant/addblogtenant', array( 'id'=>'addblogtenant', 'role'=>'form' ) ); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Upload Foto Blog Tenant</label>
