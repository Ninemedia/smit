...
<div class="row clearfix">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="header"><h2>Daftar Produk Tenant</h2></div>
            <div class="body">
                <!-- Nav tabs -->
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="add">
                        <?php echo form_open_multipart( 'tenant/producttenantadd', array( 'id'=>'producttenantadd', 'role'=>'form' ) ); ?>
...
<div class="modal fade" id="save_producttenantadd" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary waves-effect" id="do_save_producttenantadd" data-dismiss="modal">Lanjut</button>
			</div>
		</div>
	</div>
</div>
