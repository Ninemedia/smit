	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Pendaftaran Laporan Action Plan</h4>
			</div>
			<div class="modal-body">
                <p>Anda Sedang Melakukan Pendaftaran Pendaftaran Laporan Action Plan. Pastikan Data yang Anda masukan sudah benar! Terima Kasih</p>
            </div>
