            ...
            <div class="body">
                ...
                <div class="tab-content">
                                ...
                                <thead>
                                    ...
                                    <tr role="row" class="filter display-hide table-filter">
            							...
            							<td style="text-align: center;">
                                            <button class="btn bg-blue waves-effect filter-submit bottom5-min" id="btn_tenantreport_list">Search</button>
                                            <button class="btn bg-red waves-effect filter-cancel" id="btn_tenantreport_listreset">Reset</button>
            							</td>
            						</tr>
                                </thead>
                                <tbody>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="add">
                        <?php echo form_open_multipart( 'tenant/reporttenantadd', array( 'id'=>'reporttenantadd', 'role'=>'form' ) ); ?>
                        ...
                        <div class="form-group form-float">
                            <section id="">
                                ...
                                <button type="submit" class="btn btn-primary waves-effect" id="btn_reporttenantadd">Tambah Laporan</button>
                                <button type="button" class="btn btn-danger waves-effect" id="btn_reporttenantadd_reset">Bersihkan</button>
                            </section>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
                ...
                <div class="table-container table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="list_tenantreport" data-url="<?php echo base_url('tenants/laporandatauser'); ?>">
                        <thead>
    						<tr role="row" class="heading bg-blue">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="add">
                        ...
                        <div class="form-group form-float">
                            <section id="">
                                <h4>Masukan Data Notulensi Inkubasi/Tenant</h4>
                                <div class="form-group">
                                    <label class="form-label">Usulan Kegiatan Inkubasi/Tenant <b style="color: red !important;">(*)</b></label>
                                    <p>Usulan kegiatan yang sudah ada pendamping</p>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="material-icons">assignment</i></span>
                                        <select class="form-control show-tick" name="reg_event" id="reg_event">
...
<!-- BEGIN INFORMATION SUCCESS SAVE REPORT TENANT MODAL -->
<div class="modal fade" id="save_reporttenantadd" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				<h4 class="modal-title">Pendaftaran Laporan Inkubasi/Tenant</h4>
			</div>
			<div class="modal-body">
                <p>Anda Sedang Melakukan Pendaftaran Pendaftaran Laporan Inkubasi/Tenant. Pastikan Data yang Anda masukan sudah benar! Terima Kasih</p>
            </div>
			<div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Batal</button>
				<button type="button" class="btn btn-primary waves-effect" id="do_save_reporttenantadd" data-dismiss="modal">Lanjut</button>
			</div>
		</div>
	</div>
</div>
<!-- END INFORMATION SUCCESS SAVE REPORT TENANT MODAL -->

<!-- BEGIN INFORMATION SUCCESS SAVE REPORT ACTION PLAN MODAL -->
<div class="modal fade" id="save_reportactionplanadd" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				<h4 class="modal-title">Pendaftaran Action Plan</h4>
			</div>
			<div class="modal-body">
                <p>Anda Sedang Melakukan Pendaftaran Pendaftaran Action Plan. Pastikan Data yang Anda masukan sudah benar! Terima Kasih</p>
            </div>
			<div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Batal</button>
				<button type="button" class="btn btn-primary waves-effect" id="do_save_reportactionplanadd" data-dismiss="modal">Lanjut</button>
			</div>
		</div>
	</div>
</div>
