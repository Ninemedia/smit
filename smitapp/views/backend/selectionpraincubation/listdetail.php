        ...
        <div class="card">
            ...
            <div class="body">
                <div class="table-container table-responsive">                 
                    <a href="<?php echo base_url('seleksiprainkubasi/daftar'); ?>" class="btn btn-sm btn-success waves-effect back pull-right bottom25"><i class="material-icons">arrow_back</i> Kembali</a>     
