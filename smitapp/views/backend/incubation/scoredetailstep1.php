            ...
            <div class="body">
                <?php if($is_admin): ?>
                    <div class="text-right bottom25">                        
                        <a href="<?php echo base_url('inkubasi/nilai'); ?>" class="btn btn-sm btn-success waves-effect back"><i class="material-icons">arrow_back</i> Kembali</a>     
                    </div>
                    ...
                    <div class="table-container table-responsive table-incubation-score">
                        <table class="table table-striped table-bordered table-hover" data-url="<?php echo base_url('inkubasi/nilai/detail/step1/'.$data_selection->id.''); ?>">
                            <thead>
