...
<div class="modal fade" id="incdetail_comment2" tabindex="-1" role="basic" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                <div class="form-group form-float">
                    <?php echo form_open_multipart( '', array( 'id'=>'incdetail_commentstep2', 'role'=>'form' ) ); ?>
...
<div class="row clearfix">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="header">
                <h2>Penilaian Seleksi Inkubasi Tahap 2</h2>
            </div>
            <div class="body">
                <?php if($is_admin): ?>
                    ...
                    <div class="table-container table-responsive table-praincubation-score">
                        <table class="table table-striped table-bordered table-hover" id="adminscore_steptwo" data-url="<?php echo base_url('seleksiinkubasi/nilai/detail/step2/'.$data_selection->id.''); ?>">
                            <thead>
                            ...
                            <tfoot>
                                <?php
                                    // Total
                                    $sum_score2     = $this->Model_Incubation->sum_all_score2($data_selection->id);
                                    if(empty($sum_score2)){
                                        $sum_score2  = 0;
                                    }

                                    $count_all_jury2= $this->Model_Incubation->count_all_score2($data_selection->id);
                                    ...
                                    // IRL
                                    $sum_irl        = $this->Model_Incubation->sum_all_irl($data_selection->id);
                                    if(empty($sum_irl)){
                                        $sum_irl  = 0;
                                    }
