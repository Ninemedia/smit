...
var Datatable = function () {
    ...
    var tableInitialized = false;   // initialize table
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {                              // language settings
                        "sProcessing":              '<img src="'+ base_url +'smitassets/backend/images/loading-spinner-blue.gif"/><span>&nbsp;&nbsp;Loading...</span>',
                    ...
                    "fnServerParams": function ( aoData ) {
                        ...
                        for(var i in ajaxParams) {
                            ...
                            aoData.push({"name" : param.name, "value": param.value, 'csrf_smit' : $('input[name="csrf_smit"]').val()});
                        }
                    },
